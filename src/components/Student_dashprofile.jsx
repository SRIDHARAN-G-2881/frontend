...
export default function DashProfile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(`${BACKEND_URL}/server/student/update/${currentstudent._id}`, {
        method: "PUT",
        headers: {
  ...
  const handleDeleteUser = async () => {
    ...
    try {
      ...
      const res = await fetch(`${BACKEND_URL}/server/student/delete/${currentstudent._id}`, {
        method: "DELETE",
        credentials: 'include',
      });
      const data = await res.json();
  ...
  return (
    <div className="max-w-lg mx-auto p-3 w-full">
      ...
      <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
        ...
        />
        <div
          className=" relative w-12 h-12 self-center cursor-pointer shadow-md overflow-hidden rounded-full"
